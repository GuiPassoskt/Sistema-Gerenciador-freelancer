...
class Quotation extends MY_Controller {
	...
	function __construct()
	{
		...
		if($this->input->cookie('language') != ""){ $language = $this->input->cookie('fc2language');}else{ if(!empty($core_settings->language)){$language = $core_settings->language; }else{ $language = "english"; } }
