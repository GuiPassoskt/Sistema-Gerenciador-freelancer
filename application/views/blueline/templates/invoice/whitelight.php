...
<div class="top-background">
   <table width="100%" cellspacing="0" >
         ...
         <tr>
            <td style="vertical-align:top"><?=$invoice->company->name;?></td>
            <td class="right" style="vertical-align:top"></td>
        </tr> 
        <tr>
            <td style="vertical-align:top"><strong><?php if(isset($invoice->company->client->firstname)){ ?> <?=$invoice->company->client->firstname;?> <?=$invoice->company->client->lastname;?></strong><?php } ?></td>
            <td class="right" style="vertical-align:top"></td>
        </tr>
        <tr>
            <td style="vertical-align:top"><?=$invoice->company->address;?></td>
            <td class="right" style="vertical-align:top"></td>
        </tr>
        <tr>
            <td style="vertical-align:top"><?=$invoice->company->city;?>, <?=$invoice->company->zipcode;?></td>
            <td class="right" style="vertical-align:top"></td>
        </tr>
        <tr>
            <td style="vertical-align:top"><?php if($invoice->company->province != ""){?><?=$invoice->company->province;?><?php } ?></td>
            <td class="right" style="vertical-align:top"></td>
        </tr>
        <tr>
            <td style="vertical-align:top"><?php if($invoice->company->vat != ""){?><?=$this->lang->line('application_vat');?>: <?php echo $invoice->company->vat; ?><?php } ?></td>
            <td class="right" style="vertical-align:top"></td>
        </tr>
        <tr>
