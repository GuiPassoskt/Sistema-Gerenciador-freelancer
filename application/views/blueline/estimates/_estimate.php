...
<input id="status" name="status" type="hidden" value="Open"> 
 <div class="form-group">
        ...
        <div class="input-group-addon"><?=$core_settings->estimate_prefix;?></div>
            <input id="reference" type="text" name="reference" class="form-control"  value="<?php if(isset($estimate)){echo $estimate->reference;} else{ echo $core_settings->invoice_reference; } ?>"   readonly="readonly" />
        </div>
 </div>
 <div class="form-group">
